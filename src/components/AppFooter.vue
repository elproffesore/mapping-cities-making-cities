...
<template>
    <div id="credits" class="flex flex-col gap-8 md:grid md:grid-cols-2 px-8 py-4 bg-[#222] text-white pb-[5vh]">
        ...
        <div class="flex flex-col gap-2 self-start text-left">
            <h4 ><b>Concept: </b>Juliane Müller, Louisa Fortwengel, <a href="https://readymag.website/u4067123612/4241599">Giuliana Mei</a>, <a href="https://philippproff.eu">Philipp Proff</a></h4>
            ...
            <h4 ><b>Webdevelopment: </b>Philipp Proff</h4>
        </div>
        <div class="flex flex-col gap-8 md:gap-2 self-start">
            ...
            <p>This project was done as part of the class <a href="https://uclab.fh-potsdam.de/mapping/" _blank class="underline">"Mapping Cities - Making Cities"</a> at FH Potsdam in the summer semester 2024. We kindly thank Marian Dörk and Hendrik Lehmann for the intensive inputs and the support during the development of the project.</p>
        </div>
    </div>
</template>
<style>
