...
<template>
    <div class="">
        <div
            ...
            <img v-if="!mobileAndTabletCheck()" src="./assets/images/arrow.svg" @click="scrollTo('multicrisis')"
                class="cursor-pointer w-[35px] absolute bottom-1 left-[50%] translate-y-[-50%] animate-bounce" alt="">
