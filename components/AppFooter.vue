<script setup></script>
<template>
    <div id="credits" class="grid grid-cols-2 px-8 py-4 border-t border-t-gray-900 mb-[7vh]">
        <div class="flex flex-col gap-2">
            <h1><b>Impressum</b></h1>
            <h3 ><b>Concept: </b>Julinane, Louisa, Giuliana, Philipp</h3>
            <h3 ><b>Text & Content: </b>Julinane, Louisa</h3>
            <h3 ><b>Design & UI: </b>Giuliana</h3>
            <h3 ><b>Data Wrangling: </b> Louisa</h3>
            <h3 ><b>Development: </b>Philipp</h3>
        </div>
        <div class="flex flex-col gap-2">
            <h1><b>Credits</b></h1>
            <img src="/images/FHP_logo.svg" alt="" class="w-1/4 pb-4">
